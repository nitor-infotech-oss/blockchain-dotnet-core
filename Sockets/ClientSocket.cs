...
namespace blockchain.net.Sockets
{
    public class ClientSocket
    {
        ...
        private const int ReadSize = 1024; // -- 1024 keeps memory usage low but may be slow if larger amounts of data are filtering in..
